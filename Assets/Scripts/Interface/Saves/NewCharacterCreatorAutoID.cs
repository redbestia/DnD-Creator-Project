...
public class NewCharacterCreatorAutoID : MonoBehaviour
{
    ...
    public void PobierzIDzReferencji()
    {
        wybraneID = GetComponentInChildren<ObjectInListReferencePostac>().ID.ID;
    }
}
