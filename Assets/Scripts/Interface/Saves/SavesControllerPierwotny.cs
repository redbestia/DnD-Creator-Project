...
public class SavesControllerPierwotny : MonoBehaviour
{
    public static void ZapisObiektu(GameObject obiekt)
    {
        ...
        string json = JsonUtility.ToJson(obiekt.GetComponent<EkwipunekData>());  //TU
        File.WriteAllText(path, json + "\n");
        json = JsonUtility.ToJson(obiekt.GetComponent<PoziomCzaru>());  //TU
        File.WriteAllText(path, json + "\n");
        json = JsonUtility.ToJson(obiekt.GetComponent<UmiejetnoscDoRzucaniaCzarowKlasa>());
        File.AppendAllText(path, json + "\n");
        json = JsonUtility.ToJson(obiekt.GetComponent<Notatki>()); //TU
        File.AppendAllText(path, json + "\n");
        json = JsonUtility.ToJson(obiekt.GetComponent<Poziom>());  //TU
        File.AppendAllText(path, json + "\n");
        json = JsonUtility.ToJson(obiekt.GetComponent<KlasaPancerzaISzybkosc>());
        File.AppendAllText(path, json + "\n");
        json = JsonUtility.ToJson(obiekt.GetComponent<ListaBroni>());  //TU
        File.AppendAllText(path, json + "\n");
    ...
    public static void OdczytObiektow(GameObject obiekt)
    {
        ...
        if (File.ReadAllLines(path).Length != 1)
        {
            ...
            JsonUtility.FromJsonOverwrite(json, obiekt.GetComponent<EkwipunekData>());  //TU
            json = File.ReadAllLines(path)[1];
            JsonUtility.FromJsonOverwrite(json, obiekt.GetComponent<PoziomCzaru>());  //TU
            ...
            JsonUtility.FromJsonOverwrite(json, obiekt.GetComponent<Notatki>());  //TU
            json = File.ReadAllLines(path)[4];
            JsonUtility.FromJsonOverwrite(json, obiekt.GetComponent<Poziom>());  //TU
            ...
            JsonUtility.FromJsonOverwrite(json, obiekt.GetComponent<ListaBroni>());  //TU
            ...
            JsonUtility.FromJsonOverwrite(json, obiekt.GetComponent<GornyPanelData>()); //2TO MAMY
            ...
            JsonUtility.FromJsonOverwrite(json, obiekt.GetComponent<IDPostaci>()); //1TO MAMY
        }
        else
        {
